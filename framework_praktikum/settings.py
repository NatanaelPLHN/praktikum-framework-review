"""
Django settings for framework_praktikum project.
...
SECRET_KEY = "django-insecure-n2njfgj5ugg_3kyuv68ixed91cp2-q(==h5_*hb5n^i@vz%v)!"
...
ROOT_URLCONF = "framework_praktikum.urls"
...
WSGI_APPLICATION = "framework_praktikum.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        'NAME': 'pertemuan2', # Nama database yang telah dibuat di phpMyAdmin
